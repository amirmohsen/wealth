 ...
 */
const divide = (money: Money, value: number | string, rounding = ROUNDING.HALF_UP): Money => {
  const newValue = money.value.dividedBy(value).decimalPlaces(money.currency.decimalDigits, rounding as any);
